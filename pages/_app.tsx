...
// ============================================
// Este ficheiro envolve toda a app.
// Gere autenticação e redireccionamentos globais.
...
const PAGINAS_PUBLICAS = ['/', '/auth/login', '/auth/registar']
...
export default function App({ Component, pageProps }: AppProps) {
  ...
  useEffect(() => {
    if (carregando) return  // espera carregar a sessão
  ...
  // Ecrã de carregamento enquanto verifica sessão
  if (carregando) {
    return (
            ...
            {[0, 1, 2].map((i) => (
              <div
                ...
                style={{
                  ...
                  animation: `pulsar 1s ease-in-out ${i * 0.15}s infinite`,
                }}
              />
            ))}
          </div>
