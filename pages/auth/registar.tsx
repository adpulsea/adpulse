...
export default function PaginaRegistar() {
      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--cor-fundo)' }}>
          <div className="card max-w-md w-full text-center p-8">
            ...
            <h1 className="text-2xl font-bold mb-3" style={{ fontFamily: 'var(--fonte-display)' }}>
              Conta criada!
            </h1>
            ...
            <Link href="/auth/login" className="btn-primario justify-center">
              Ir para o login
            </Link>
          </div>
        </div>
  ...
  return (
    <>
      <Head>
        <title>Criar conta grátis — AdPulse</title>
      </Head>
      ...
      >
        ...
        <div className="w-full max-w-md relative z-10">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="nome" type="text" value={nome}
                    ...
                    className="input-campo pl-11" required autoComplete="name" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="email" type="email" value={email}
                    ...
                    className="input-campo pl-11" required autoComplete="email" />
                </div>
              </div>
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'var(--cor-texto-muted)' }}>
            Já tens conta?{' '}
            <Link href="/auth/login" style={{ color: 'var(--cor-marca)' }} className="font-medium hover:underline">
              Fazer login
            </Link>
          </p>
        </div>
